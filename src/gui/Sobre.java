...
public class Sobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Av. Paulista 1000 - São Paulo, SP");

        jLabel3.setText("Alunos:");

        jLabel4.setText("Guilherme Bella Mendes");

        jLabel5.setText("Rafael Wenzel Modenese");

        jLabel6.setText("Patrick Mirabelli Ferreira");
